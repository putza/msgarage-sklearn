...
This project was created by cookiecutter data science project template. For this demo, only the notebook directory is created.
    ...
    ├── msglearn           <- Source code for use in this project.
